...
<ArtistCard text2="" images={resources.Laura.images}  text1="Junto a Horacio hemos trabajado en varias oportunidades, siempre en torno al diagnóstico por imágenes, en esta oportunidad nos encontramos con la idea de realizar una serie de objetos reconstruidos en 3D desde tomografía computadorizada para luego ser destruidos y reconstruidos mediante la técnica de kintsugi.

" name="Horacio Acerbo" img="https://imagedelivery.net/rXQkQjLMcsIgr9J-xeKCWA/65a3eab3-a093-4124-ad63-93774ae93c00/public" />

<ArtistCard name="Laura Heiss" images={resources.Laura.images} text2="" text1=" Laura se acercó a nuestro estudio con la necesidad de trabajar con material de diagnóstico por imágenes (TAC). Y viendo el potencial de su obra le propusimos construir su propia web page, una muestra itinerante y trabajar a fondo en renders y clases de arte complementando de manera hands-on sus estudios en arte terapia. Logró junto a nosotros crear su propio diálogo de obra encontró la materia prima de su trabaJo
...
<ArtistCard name="Jessica Roudes" images={resources.Laura.images}  text2="" text1=" El caso de Jessica fué especial para nosotros ella poseía diferentes TACs (tomografìa computarizada) de frutas y verduras y necesitaba hacer una limpieza aprendiendo en el proceso cómo organizar las herramientas
