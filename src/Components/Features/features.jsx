...
export const Feature = () => {
    return (
      <div className="bg-white text-center sm:text-left px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10 ">
          ...
          <div className="lg:w-1/2">
            <p className="text-base text-gray-700 md:text-lg">
              Ofrecemos varios servicios en tecnologias que involucran modelos 3ds y participamos de varios proyectos
            </p>
          </div>
        </div>
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4 ">
          <div className="">
            <div className="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
              <svg
                className="w-7 h-7 content-center text-deep-purple-accent-400"
                strokeLinecap="round"
                strokeWidth="2"
                viewBox="0 0 24 24"
              >
            ...
            <h6 className="mb-2 font-semibold leading-5">Diseño Web</h6>
            <p className="mb-3 text-sm text-gray-900">
              Ofrecemos varios servicios de frontend y backend para potenciar tu proyecto
            </p>
          ...
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Modelos 3d</h6>
            <p className="mb-3 text-sm text-gray-900">
          ...
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Proyectos Artisticos</h6>
            <p className="mb-3 text-sm text-gray-900">
